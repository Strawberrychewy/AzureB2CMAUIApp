...
{
    private const string AndroidRedirectURI = "msauth://{INSERT-ANDROID-REDIRECT-URI-HERE}/{GUID}";//This URI is the same as the redirect uri set up in Azure, for both Microsoft login and Socials login
